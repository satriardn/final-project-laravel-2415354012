<div class="modal fade" id="addDataModal" tabindex="-1" aria-labelledby="addDataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 650px; width: 100%; overflow: visible;">
        <div class="modal-content bg-white rounded-2xl p-6 shadow-xl border border-slate-100" style="overflow: visible;">
            <h2 class="text-xl font-bold text-slate-900 text-center mb-6">Add Service</h2>
            <form action="{{ route('services.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="block font-semibold text-slate-700 text-sm mb-1.5">Service Name</label>
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-800 placeholder-slate-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 focus:outline-none transition-all duration-200" placeholder="Enter service name">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="price" value="{{ old('price') }}" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-800 placeholder-slate-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 focus:outline-none transition-all duration-200" placeholder="Enter price">
                ...
                <div class="mb-4">
                    ...
                    <textarea rows="3" name="description" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-800 placeholder-slate-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 focus:outline-none transition-all duration-200 resize-none" placeholder="Enter description">{{ old('description') }}</textarea>
