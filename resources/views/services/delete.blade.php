<div class="modal fade" id="deleteDataModal" tabindex="-1" aria-labelledby="deleteDataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 440px; width: 100%;">
        <div class="modal-content bg-white rounded-2xl p-6 shadow-xl border border-slate-100 text-center">
            ...
            <p class="text-slate-500 text-sm mb-6 leading-relaxed">Are you sure you want to delete <span id="delete_service_name" class="font-semibold text-slate-800"></span>?<br>This action cannot be undone.</p>
